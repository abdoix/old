    ...
    *{
    ...
    .mainnav:nth-child(1) #theul{
      list-style-type: none;
      text-align: center;
    }

    .mainnav:nth-child(1) #theul #theli{
      line-height:60px;
      display: inline-block;
      /* font-size: 10px; */
      padding: 0 20px;
    }
    .mainnav:nth-child(1) .logo{
      line-height:60px;
      padding-left: 5px;
      font-weight: 500;
    }
    .mainnav:nth-child(1) #theul #theli a{
      position: relative;
      font-weight: 200;
      color: #cacaca;
    ...
    .mainnav:nth-child(1) #theul #theli a::after{
      position: absolute;
      content: '';
      width: 0%;
      height: 3px;
    ...
    .mainnav:nth-child(1) #theul #theli a:hover::after{
      width: 100%;
      opacity:1;
    }
    .mainnav:nth-child(1) #theul #theli a:hover{
      color: #16181b;
    }
    .activeli{
...
<?php
    ...
    while(!feof($myfolder)){
      $myline = trim(fgets($myfolder));
      if($myline != "")
      {
          $mytab = explode("|",$myline);
          $mydata .= $myline;
          $mydata .= "\r\n";


          // $tst = join(' ',$mytab);
        // $tst = trim(fgets($myfolder));
        if(isset($_SESSION['user']))
        {
          // echo "<script>console.log('hello')</script>";
          if($mytab[0] == $_SESSION['user'] && $mytab[3] == $_SESSION['pass'])
          {
            // echo "<script>console.log('hello')</script>";
              $user=$mytab[0];
              if(isset($mytab[1]))
              ...
              {
                $morea =$mytab[2];
                $moreaarray = explode(",",$morea);
                $image = $moreaarray[0];
                $userage = $moreaarray[1];
                $gender = $moreaarray[2];
                $loas = $moreaarray[3];
              }
...
?> 
    ...
    <div class="row align-items-center g-5 " style="position: relative;">
      ...
      <nav class='fixed-top mainnav'>
        ...
        <ul id="theul">
          <li id="theli"><a class="a" href="index.php">Home</a></li>
          <li id="theli"><a class="a" href="form.php">Register</a></li>
          <li id="theli"><a class="a" href="search.php">Search</a></li>
</button>
      ...
      <li class="d-inline-block" > 
        <div class="dropdown custom-dropdown ">
          ...
          {
            $myarr = testread($_SESSION['user'],$_SESSION['pass']);
            $more = explode(',',$myarr[2]);
            echo "<img src='img/users/$more[0]' alt='Image' width='40' height='40' class='user-img rounded-circle my-auto'>";
          }
          ?>
          </div>
          </a>
      <div class="dropdown-menu px-0 pl-0" aria-labelledby="dropdownMenuButton" style="position: relative !important;margin-top:-12px !important;margin-right:30px;">
          ...
          <li class="px-0">
            <div class="d-flex align-items-center">
              ...
              <div class="avatar pr-2">
                <img class="avatar-img rounded-circle shadow" src="img/users/<?=$more[0]?>"; alt="avatar" width='40' height='40' class="user-img rounded-circle">
              </div>
              <div>
                <a class="h6" href="#">@<?=$_SESSION['user']?></a>
                <p class="small m-0"><?=$_SESSION['user']?>@gmail.com</p>
              </div>
            </div>
            <hr>
          </li>
          ...
          <li class="py-1"><a class="dropdown-item pl-1" href="logout.php"><i class="fas fa-sign-out-alt px-1"></i>Log out</a></li>
			...
			<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
				...
				<figure class="fill-warning position-absolute bottom-0 end-0 me-5 d-none d-xl-block">
					<svg fill='#dc3545'  width="42px" height="42px">
				...
				<figure class="fill-success position-absolute top-0 start-50 translate-middle-x mt-n5 ms-5">
					<svg fill='#fd7e14' width="22px" height="21px">
        ...
        <!-- Info -->
				...
				<div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
					<!-- Button -->
					<a href="#" class="btn btn-lg btn-primary shadow mx-auto" style="opacity: 80%;">Get Started</a>
			...
			<div class="col-lg-7 col-xl-6 text-center position-relative">
				...
				<figure  class="position-absolute bottom-0 start-50 translate-middle-x mt-4 mb-0">
					<svg fill="#007BFF" width="550px" height="538px" viewBox="0 0 554 544" style="enable-background:new 0 0 554 544;" xml:space="preserve">
